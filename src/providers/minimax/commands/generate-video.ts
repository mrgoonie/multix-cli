...
import { MINIMAX_VIDEO_MODELS, TASK_DEFAULTS, VIDEO_DURATIONS, VIDEO_RESOLUTIONS } from "../models.js";
...
export function registerMinimaxGenerateVideoCommand(parent: Command): void {
  parent
    ...
    .action(async (opts: {
      ...
      if (result.generationTime) console.log(`Generation time: ${result.generationTime.toFixed(1)}s`);
