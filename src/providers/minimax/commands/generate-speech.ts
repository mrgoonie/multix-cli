...
import { MINIMAX_SPEECH_MODELS, TASK_DEFAULTS, SPEECH_FORMATS } from "../models.js";
...
export function registerMinimaxGenerateSpeechCommand(parent: Command): void {
  parent
    ...
    .option("--emotion <e>", "Emotion (neutral|happy|sad|angry|fearful|disgusted|surprised)", "neutral")
